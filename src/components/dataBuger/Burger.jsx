    ...
    <div>
      <div className="flex items-center gap-x-40  w-screen h-screen mx-auto justify-center">
        <div className="flex flex-col justify-center items-center gap-y-2 w-[400px]">
          <h2 className="text-blue-700 text-2xl font-semibold mb-20">
            Store Burger
          </h2>
        ...
        <div className="">
          <table className="table">
            <thead>
              ...
              <tr>
                <th scope="col" className="h-[40x] leading-[40px] text-center">
                  Food
                </th>
                <th scope="col"></th>
                <th scope="col" className="h-[40x] leading-[40px] text-center">
            ...
            <tbody>
              ...
              <tr>
                <td></td>
                <td className="h-[40x] leading-[40px] text-center">Total:</td>
                <td className="h-[40x] leading-[40px] text-center text-slate-800 text-xl">
