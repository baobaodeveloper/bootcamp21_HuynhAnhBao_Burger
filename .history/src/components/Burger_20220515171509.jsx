            ...
            <tbody>
              <tr>
                ...
                <td className="flex items-center gap-x-3">
                  <button className="w-5 h-5 flex items-center justify-center text-white leading-none rounded-md bg-green-500">
                    +
                  </button>
                  <button className="w-5 h-5 flex items-center justify-center text-white leading-none rounded-md bg-red-500">
                    -
                  </button>
                </td>
                <td>@mdo</td>
