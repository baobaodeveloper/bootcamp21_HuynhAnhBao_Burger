          ...
          <div className="flex items-center gap-x-5">
            ...
            <div className="flex flex-col gap-y-5">
              ...
              <span className="flex gap-x-3">
                <button className="p-2 leading-none text-lg bg-green-500 text-white rounded-lg">
                  +
                </button>
                <button className="p-2 leading-none text-lg bg-red-500 text-white rounded-lg">
                  -
                </button>
              </span>
              <span className="flex gap-x-3">
